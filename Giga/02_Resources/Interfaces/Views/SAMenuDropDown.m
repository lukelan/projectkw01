...
- (id)initWithSource:(UIButton *)sender itemNames:(NSArray *)nameArray itemImagesName:(NSArray *)imageArray itemSubtitles:(NSArray *)subtitleArray
{
    ...
    self = [self initWithWithSource:sender menuHeight:(kSACellHeight*(nameArray.count-2))
...
- (void)uiSetUp
{
    ...
    _tableMenu.separatorColor = RGB(26, 178, 255);
    ...
    _tableMenu.layer.masksToBounds =YES;
    _tableMenu.layer.borderWidth = 1;
    _tableMenu.layer.borderColor =  RGB(26, 178, 255).CGColor;//[[UIColor blueColor] CGColor];
...
//    cell.layer.borderColor =  RGB(26, 178, 255).CGColor;
